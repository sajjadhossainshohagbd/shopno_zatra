                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ $hotel->show_thumbnail }}" width="30%" class="img-thumbnail">
                                    </td>
                                    <td>{{ $hotel->name }}</td>
                                    <td>
                                        @if(auth()->user()?->role == 'agent')
                                        <del><span><b>Original Price</b> : {{ $hotel->price }} BDT</span></del> <br>
                                        <span><b>B2B Price</b> : {{ $hotel->b2b_price }} BDT</span> <br>
                                        @else
                                        {{ $hotel->price }} BDT
                                        @endif
                                    </td>
