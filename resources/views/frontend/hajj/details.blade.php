                ...
                <div class="card shadow">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <h2>{{ $hajj->package_name }}</h2>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ $hajj->show_thumbnail }}" alt="Thumbnail" class="img-thumbnail img-fluid"><br>
                            <b class="p-2"><h3>Start From <b>{{ round($hajj->start_from) }} BDT</b></h3></b>
                        </div>
