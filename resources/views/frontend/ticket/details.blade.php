                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{ $ticket->show_thumbnail }}" alt="Thumbnail" class="img-thumbnail img-fluid"><br>
                            <b class="p-2"><h3>Price : <b>{{ round($ticket->price) }} BDT</b></h3></b>
                        </div>
