                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ $ticket->show_thumbnail }}" width="30%" class="img-thumbnail">
                                    </td>
                                    <td>{{ $ticket->name }}</td>
                                    <td>
                                        @if(auth()->user()?->role == 'agent')
                                        <del><span><b>Original Price</b> : {{ $ticket->price }} BDT</span></del> <br>
                                        <span><b>B2B Price</b> : {{ $ticket->b2b_price }} BDT</span> <br>
                                        @else
                                        {{ $ticket->price }} BDT
                                        @endif
                                    </td>
