        ...
        <div class="p-2">
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <h6 class="bg-app text-white p-2">Selected Service</h6>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ $service->show_thumbnail }}" width="30%" class="img-thumbnail">
                                    </td>
                                    <td>{{ $service->name }}</td>
                                    <td>
                                        @if(auth()->user()->role == 'agent')
                                        <del><span><b>Original Price</b> : {{ $service->price }} BDT</span></del> <br>
                                        <span><b>B2B Price</b> : {{ $service->b2b_price }} BDT</span> <br>
                                        @else
                                        {{ $service->price }} BDT
                                        @endif
                                    </td>
