...
<body>
    <div class="container bg-white">
        <h1 class="text-center p-4 border-bottom">Special CV Order - {{ config('app.name') }}</h1>
        <div class="card">
            <div class="card-body">
                @session('success')
                ...
                @if($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{ route('special.cv.order') }}" method="POST" id="form" enctype="multipart/form-data">
                    @csrf
                    <!-- Personal Info -->
                    <h3>Personal Info</h3>
                    <section>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="cv_delivery_email">CV Delivery Email</label>
                                    <input type="text" class="form-control" id="cv_delivery_email" name="cv_delivery_email" placeholder="Enter cv delivery email">
                                </div>
                            </div>
