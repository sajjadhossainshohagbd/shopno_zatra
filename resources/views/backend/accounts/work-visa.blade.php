<div>
    <div class="container-fluid">
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Work Visa Accounts</h4>
        </div>
                        ...
                        <table class="table table-boredered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('work.visa.details',$pack->work->id) }}" target="_blank">
                                            <img src="{{ $pack->work->showThumbnail }}" alt="Thumbnail" width="150" class="img-thumbnail" >
                                            {{ $pack->work->name ?? 'N/A' }}
                                        </a>
                                    </td>
