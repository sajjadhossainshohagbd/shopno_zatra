<div>
    <div class="container-fluid">
        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Medical Visa Accounts</h4>
        </div>
                        ...
                        <table class="table table-boredered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('medical.visa.details',$pack->medical->id) }}" target="_blank">
                                            <img src="{{ $pack->medical->showThumbnail }}" alt="Thumbnail" width="150" class="img-thumbnail" >
                                            {{ $pack->medical->name ?? 'N/A' }}
                                        </a>
                                    </td>
