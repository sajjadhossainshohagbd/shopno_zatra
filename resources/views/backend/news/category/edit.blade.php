                ...
                <div class="card-body">
                    <form wire:submit='save'>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="slug" wire:model="slug" type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="Enter title">
                            @error('slug')
                                <div class="text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success btn-rounded" wire:loading.attr='disabled'>Update Category</button>
                        </div>
                    </form>
                </div>
            </div>
