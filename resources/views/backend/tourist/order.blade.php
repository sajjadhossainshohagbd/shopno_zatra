<div>
    <div class="row mb-2">
        <div class="col-6">
            <h5>Tourist Orders</h5>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">Tourist Orders</div>
        </div>
        <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $order->id }}'>
                            ...
                            <td>
                                <a href="{{ route('tourist.details',$order->tourist_id) }}" target="_blank">
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('tourist.order.details',$order->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                    <li class="list-inline-item">
