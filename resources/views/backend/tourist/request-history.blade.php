<div>
    <div class="row mb-2">
        <div class="col-6">
            <h5>Tourist Pack Request</h5>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">Tourist Pack Request</div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('tourist.request.details',$history->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                    <li class="list-inline-item">
