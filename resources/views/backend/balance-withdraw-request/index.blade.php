<div>
    <div class="row mb-2">
        <div class="col-6">
            <h5>{{ ucfirst($type) }} Balance Withdraw Requests</h5>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">{{ ucfirst($type) }} Balance Withdraw Requests</div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('balance.withdraw.details',$request->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                    <li class="list-inline-item">
