<div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Hotel Orders</div>
        </div>
        <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $order->id }}'>
                            ...
                            <td>
                                <a href="{{ route('hotel.details',$order->hotel_id) }}" target="_blank">
                                    {{ $order->hotel?->name ?? '--' }}
                                </a>
                            </td>
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('hotel.order.details',$order->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
