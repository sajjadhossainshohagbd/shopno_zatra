                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $order->id }}'>
                            ...
                            <td>
                                <a href="{{ route('work.visa.details',$order->work_id) }}" target="_blank">
                                    {{ $order->work?->name ?? '--' }}
                                </a>
                            </td>
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('work.visa.order.details',$order->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                    <li class="list-inline-item">
