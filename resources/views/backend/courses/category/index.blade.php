        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div>
                            <a href="{{ route('categories.add') }}" class="btn btn-success waves-effect waves-light mb-3"><i class="mdi mdi-plus me-1"></i> Add Category</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr wire:key='{{ $category->id }}'>
                                ...
                                <td>
                                    <img src="{{ $category->show_icon }}" alt="Icon" class="img-thumbnail" >
                                </td>
                                <td>{{ $category->name }}</td>
                                <td>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item">
                                            <a href="{{ route('categories.edit',$category->id) }}" class="px-2 text-primary"><i class="uil uil-pen font-size-18"></i></a>
                                        </li>
                                        <li class="list-inline-item">
