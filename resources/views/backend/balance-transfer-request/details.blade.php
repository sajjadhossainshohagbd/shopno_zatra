<div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Balance Transfer Request Details</div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-12 p-4">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <select class="form-select" wire:confirm='Are you sure?' wire:change='updateStatus($event.target.value)' @disabled($balance->status == 'approved' && $balance->status == 'cancelled')>
