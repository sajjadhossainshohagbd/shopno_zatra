<div>
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                <div class="text-end">
                    <a href="{{ route('b2b.add.bank') }}" class="btn btn-outline-success btn-rounded">Add Bank</a>
                </div>
            </div>
        </div>
                                ...
                                <td>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item">
                                            <a href="{{ route('b2b.edit.bank',$bank->id) }}" class="px-2 text-primary"><i class="uil uil-pen font-size-18"></i></a>
                                        </li>
                                        <li class="list-inline-item">
