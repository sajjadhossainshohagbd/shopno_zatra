<div>
    <div class="row mb-2">
        <div class="col-6">
            <h5>Agent Request List</h5>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">Agent Request List</div>
        </div>
        <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $request->id }}'>
                            ...
                            <td>
                                <img src="{{ $request->logo_url }}" class="avatar-sm">
                            </td>
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('agent.request.details',$request->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                    <li class="list-inline-item">
