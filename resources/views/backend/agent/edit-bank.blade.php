            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit='save'>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="account_type">Account Type<small class="text text-danger">*</small></label>
                            <select wire:model="account_type" class="form-select @error('account_type') is-invalid @enderror">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success btn-rounded" wire:loading.attr='disabled'>Update Bank</button>
                        </div>
                    </form>
                </div>
            </div>
