<div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Hajj Orders</div>
        </div>
        <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr wire:key='{{ $order->id }}'>
                            ...
                            <td>
                                <a href="{{ route('hajj.details',['type' => $order->hajj->type,'id' => $order->hajj->id]) }}" target="_blank">
                                    {{-- <img src="{{ $order->hajj->showThumbnail }}" alt="Thumbnail" class="img-thumbnail"> --}}
                                    {{ $order->hajj?->package_name ?? '--' }}
                                </a>
                            </td>
                            ...
                            <td>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a href="{{ route('b2b.hajj.visa.details',$order->id) }}" class="px-2 text-primary"><i class="uil uil-eye font-size-18"></i></a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
