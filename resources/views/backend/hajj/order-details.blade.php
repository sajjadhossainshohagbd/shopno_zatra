        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    {{-- <div><span class="fw-bold">Name : </span>{{ $order->name }}</div>
                    <div><span class="fw-bold">Phone : </span>{{ $order->phone }}</div>
                    <div><span class="fw-bold">Guardian Name : </span>{{ $order->guardian_name }}</div>
                    <div><span class="fw-bold">Guardian Phone : </span>{{ $order->guardian_phone }}</div>
