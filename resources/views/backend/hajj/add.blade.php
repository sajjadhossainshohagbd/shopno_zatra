                ...
                <div class="card-body">
                    <form wire:submit='save'>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="b2b_price" wire:model="form.b2b_price" type="number" class="form-control @error('form.b2b_price') is-invalid @enderror" placeholder="Enter b2b price">
                            @error('form.b2b_price')
                                <div class="text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
