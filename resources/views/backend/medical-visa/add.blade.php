            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit='save'>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="program">Program <small class="text text-danger">*</small></label>
                            <input id="program" wire:model="program" type="text" class="form-control @error('program') is-invalid @enderror" placeholder="Enter program">
                            @error('program')
                                <div class="text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
