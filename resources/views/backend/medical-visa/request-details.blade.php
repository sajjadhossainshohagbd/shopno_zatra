                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ asset($request->previous_report) }}" target="_blank">Click here to view</a>
                                @else
                                ---
                                @endif
                            </td>
                        ...
                        <tr>
                            <th>Guardian NID :</th>
                            <td>
                                @if($request->guardian_nid)
                                <a href="{{ asset($request->guardian_nid) }}" target="_blank">Click here to view</a>
                                @else
                                ---
                                @endif
                            </td>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $request->type_of_disease }}</td>
                        </tr>
                        <tr>
                            <th>Preferred Hospital :</th>
                            <td>{{ $request->preferred_hospital ?? '---'}}</td>
                        </tr>
                    </table>
                </div>
