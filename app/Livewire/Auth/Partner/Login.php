...
namespace App\Livewire\Auth\Partner;
...
class Login extends Component
{
    ...
    public function login(): void
    {
        ...
        $user = User::whereIn('role',['buyer','agent'])->where($fieldName,$this->email)->first();
        ...
        $user->role == 'buyer' ? $this->redirect(route('buyer.dashboard')) : $this->redirect(route('agent.dashboard'));
    }
